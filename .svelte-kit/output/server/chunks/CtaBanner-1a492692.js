...
var CtaBanner_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => ".logo-img.svelte-15pn00a{width:auto;height:5rem;padding-right:16px}h1.svelte-15pn00a{font-weight:bold;text-align:center}p.svelte-15pn00a{text-align:center}.container-fluid.svelte-15pn00a{margin-top:25px;margin-bottom:10px}.main-text-post.svelte-15pn00a{text-align:justify}@media(min-width: 1921px){.container-fluid.svelte-15pn00a{margin-top:5px}.main-text-main.svelte-15pn00a{font-size:80px;line-height:80px;margin-top:40px;margin-bottom:35px}.main-text-post.svelte-15pn00a{font-size:30px;line-height:35px;text-align:center}}@media(max-width: 1920px) and (min-width: 1400px){.container-fluid.svelte-15pn00a{margin-top:25px}.main-text-main.svelte-15pn00a{font-size:76px;line-height:70px;margin-bottom:40px}.main-text-post.svelte-15pn00a{font-size:26px;line-height:27px}}@media(max-width: 1399px) and (min-width: 992px){.main-text-main.svelte-15pn00a{font-size:60px;line-height:60px;margin-bottom:20px}.main-text-post.svelte-15pn00a{font-size:22px;line-height:25px}}@media(max-width: 991px) and (min-width: 768px){.container-fluid.svelte-15pn00a{width:90%;max-width:1000px}.main-text-main.svelte-15pn00a{font-size:48px;line-height:48px;margin-bottom:15px}.main-text-post.svelte-15pn00a{font-size:18px;line-height:23px}}@media(max-width: 767px){.logo-img.svelte-15pn00a{width:auto;height:3rem;padding-right:16px}.container-fluid.svelte-15pn00a{width:90%;max-width:1000px;margin-bottom:10px;margin-top:19px}#title-content-wrapper.svelte-15pn00a{text-align:center;max-width:500px}.main-text-main.svelte-15pn00a{font-size:35px;line-height:42px;margin-bottom:10px;max-width:480px}.main-text-post.svelte-15pn00a{font-size:18px;line-height:23px;max-width:510px ;text-align:center}}")();
const css = {
  code: ".logo-img.svelte-15pn00a{width:auto;height:5rem;padding-right:16px}h1.svelte-15pn00a{font-weight:bold;text-align:center}p.svelte-15pn00a{text-align:center}.container-fluid.svelte-15pn00a{margin-top:25px;margin-bottom:10px}.main-text-post.svelte-15pn00a{text-align:justify}@media(min-width: 1921px){.container-fluid.svelte-15pn00a{margin-top:5px}.main-text-main.svelte-15pn00a{font-size:80px;line-height:80px;margin-top:40px;margin-bottom:35px}.main-text-post.svelte-15pn00a{font-size:30px;line-height:35px;text-align:center}}@media(max-width: 1920px) and (min-width: 1400px){.container-fluid.svelte-15pn00a{margin-top:25px}.main-text-main.svelte-15pn00a{font-size:76px;line-height:70px;margin-bottom:40px}.main-text-post.svelte-15pn00a{font-size:26px;line-height:27px}}@media(max-width: 1399px) and (min-width: 992px){.main-text-main.svelte-15pn00a{font-size:60px;line-height:60px;margin-bottom:20px}.main-text-post.svelte-15pn00a{font-size:22px;line-height:25px}}@media(max-width: 991px) and (min-width: 768px){.container-fluid.svelte-15pn00a{width:90%;max-width:1000px}.main-text-main.svelte-15pn00a{font-size:48px;line-height:48px;margin-bottom:15px}.main-text-post.svelte-15pn00a{font-size:18px;line-height:23px}}@media(max-width: 767px){.logo-img.svelte-15pn00a{width:auto;height:3rem;padding-right:16px}.container-fluid.svelte-15pn00a{width:90%;max-width:1000px;margin-bottom:10px;margin-top:19px}#title-content-wrapper.svelte-15pn00a{text-align:center;max-width:500px}.main-text-main.svelte-15pn00a{font-size:35px;line-height:42px;margin-bottom:10px;max-width:480px}.main-text-post.svelte-15pn00a{font-size:18px;line-height:23px;max-width:510px ;text-align:center}}",
  map: null
};
const CtaBanner = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<section id="${"ctabanner"}" class="${"bg-primary d-flex align-items-center"}"><div class="${"container-fluid svelte-15pn00a"}"><div class="${"row justify-content-center my-3"}"><div id="${"title-content-wrapper"}" class="${"col-md-7 col-xl-9 svelte-15pn00a"}"><h1 class="${"main-text-main text-light svelte-15pn00a"}">
            ${escape(HEADING)}</h1>
      
        <p class="${"main-text-post text-light svelte-15pn00a"}">${escape(DESCRIPTION)}</p></div></div>
    ...
    <div class="${"row justify-content-center my-2"}"><section id="${"contact"}"><div class="${"container-lg"}"><div class="${"row justify-content-center"}"><div class="${"col-lg-6"}"><form action="${"https://formsubmit.co/info@orbisnauta.com"}" method="${"POST"}"><label for="${"email"}" class="${"form-label text-light"}">${escape(FORM_EMAIL)}</label>
                ...
                <div class="${"mb-1 text-center"}"><img src="${"images/virtual_reality_ development_agency_orbisnauta_logo.png"}" class="${"logo-img img-fluid svelte-15pn00a"}" alt="${""}"></div></form></div></div></div></section></div></div>
</section>`;
});
