...
const SERVICESINDIVIDUAL_2_BANNER_DATA = {
  ...
  SERVICE_DESCRIPTION_3: "Why conform with normal photos? Blow up your social media with 360\xBA photos that promote engagement and interactive web tours accessible to anyone with a PC or a smartphone.",
  SERVICE_TITLE_4: "360 Video Streaming: ",
  SERVICE_DESCRIPTION_4: "Get transported to an event at a stadium, convention center or even a concert while it\u2019s being performed. We help you share your experience with the world with zero limits in time or number of users. Reach a broader audience, allowing anyone to be inside your live 360\xBA video recording in real time.",
  PORTFOLIO_BUTTON: "Our Portfolio"
};
...
const MOCK_DATA = {
  ...
  CTASMALLBANNER_DATA,
  MAINREELBANNER_DATA,
  REELTAB_1_BANNER_DATA,
  REELTAB_2_BANNER_DATA,
  REELTAB_3_BANNER_DATA,
  REELTAB_4_BANNER_DATA,
  REELTAB_5_BANNER_DATA,
  REELTAB_6_BANNER_DATA,
  REELTAB_7_BANNER_DATA,
  REELTAB_8_BANNER_DATA,
  REELTAB_9_BANNER_DATA,
  REELTAB_10_BANNER_DATA,
  REELTAB_11_BANNER_DATA,
  REELTAB_12_BANNER_DATA,
  SERVICESMAIN_BANNER_DATA,
  SERVICESINDIVIDUAL_1_BANNER_DATA,
  SERVICESINDIVIDUAL_2_BANNER_DATA,
  SERVICESINDIVIDUAL_3_BANNER_DATA,
  SERVICESINDIVIDUAL_4_BANNER_DATA,
  SERVICESINDIVIDUAL_5_BANNER_DATA
};
